...
public class UpdateTodoViewModel extends ViewModel {
    public MutableLiveData<TodoResource> apiResponse = new MutableLiveData<>();

    public void updateTodoItem(Context context, TodoModel todoModel) {
        String url = ApiConstant.BASE_URL + ApiConstant.PUT_TODO_ENDPOINT + todoModel.getId();
        ...
        try {
            ...
            client.put(context, url, jsonRequest, "application/json", new AsyncHttpResponseHandler() {
                @Override
